...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[250vh] mb-[-30px] py-10 overflow-hidden relative flex flex-col bg-black antialiased [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-200">
        Our future goal is to become the go-to digital partner for ambitious
        businesses everywhere. From local startups to global brands  we’re
        scaling our services, team, and technology to serve worldwide success.
      </p>
    </div>
  );
};
